...
double Controller::bw_slope() {
  ...
  for (auto it = last_bw_estimate; it != end; ++it) {
    numerator += ((it->first - curr_bw_estimate_timestamp) - avgX) * (it->second - avgY);
    denominator += ((it->first - curr_bw_estimate_timestamp) - avgX) * ((it->first - curr_bw_estimate_timestamp) - avgX);
  }
  ...
  if (numerator / denominator < -0.2) {
    // cerr << "FOUND " << (numerator / denominator) << endl << endl << endl << endl;
    // cerr << "FOUND " << (numerator / denominator) << endl << endl << endl << endl;
    // cerr << "FOUND " << (numerator / denominator) << endl << endl << endl << endl;
    // cerr << "FOUND " << (numerator / denominator) << endl << endl << endl << endl;
    // cerr << "FOUND " << (numerator / denominator) << endl << endl << endl << endl;
